/* ------------------------------------------------------------
	...
	DATE:		1993.4.18
	AUTHOR:		Bob Kong
	FUNCTION:	Offer a function: get_account(), which gets an account
				string(digital string includes '+' & '-').
   ------------------------------------------------------------ */
#include	<mem.h>
#include	<graphics.h>
#include	<stdio.h>
...
/* ----------------------------------------------------------------------
	FUNCTION:	Read an account string (digital string includes '-' & '+').
   ...
   ---------------------------------------------------------------------- */
UC	get_account(UI pos_sx, UI pos_sy, UI high, UI width, UI back_in,
...
UI 		char_sx, char_sy, char_ex, char_ey;
					     /* indicates the characters echo range. */
